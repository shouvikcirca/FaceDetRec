...
# Adding img1_Frame and img2_Frame
def verify(img1_Frame = None, img2_Frame = None, img1_path='', img2_path = '', model_name = 'VGG-Face', distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base'):
	...
	img_list, bulkProcess = functions.initialize_input(img1_Frame, img2_Frame)
	...
	for index in pbar:
		...
		# Accomodating numpy arrays instead of paths
		if type(instance) == list and len(instance) >= 2:
			#img1_path = instance[0]; img2_path = instance[1]
			img1_Frame = instance[0]
			img2_Frame = instance[1]
			...
			for i in  model_names:
				...
				img1_representation = represent(img1_Frame
				...
				img2_representation = represent(img2_Frame
						, model_name = model_name, model = custom_model
						, enforce_detection = enforce_detection, detector_backend = detector_backend
						, align = align
						, normalization = normalization
...
def represent(imgFrame, model_name = 'VGG-Face', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, normalization = 'base'):
	...
	# Accomodating numpy arrays instead of paths
	img = functions.preprocess_face(imgFrame
